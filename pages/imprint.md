...
To be clear about our privacy policy ([Art 12 of GDPR](https://gdpr-info.eu/art-12-gdpr/)), we need to differentiate two cases: Navigating through the website and contributing to the website

## Navigating through the website
By navigating through the website, we are referring to the activities (mainly accessing information) in [https://victor-fancelli-capdevila.github.io/abc_dl/](https://victor-fancelli-capdevila.github.io/abc_dl/) or subpages that have something after /abc_dl/, for example, [our imprint page at https://victor-fancelli-capdevila.github.io/abc_dl/imprint.html](https://victor-fancelli-capdevila.github.io/abc_dl/imprint.html).
...
### We use GitHub, and they have their own privacy policies
We use GitHub Inc. or GitHub B.V. for managing version control of the contributions and hosting the website. [Here you can check the privacy policies of GitHub](https://docs.github.com/en/site-policy/privacy-policies). GitHub will save some personal information data, and you should contact them if you have any issue or question.

Their data policy is valid when you are in the  [GitHub project's repository, which is https://github.com/victor-fancelli-capdevila/abc_dl/](https://github.com/victor-fancelli-capdevila/abc_dl/). Note the difference between the aspect and the link in the repository and the website where content is displayed, which is victor-fancelli-capdevila.github.io/abc_dl/ (GitHub.io in the middle vs a GitHub.com at the beginning). For archive or documentation purposes of the course, we may make a copy of the repository, with all the data in it.

### We offer alternatives to GitHub (with their policies too)
The project is (also) a course in the HfG Karlsruhe, which is also providing services that you may use for making a contribution as an alternative to GitHub. Two platforms are especially relevant: Moodle, where we use the [Moodle of the course](https://moodle.hfg-karlsruhe.de/course/view.php?id=744) and Nextcloud, where you can [joint the circle of the course and get access to our shared folder](https://cloud.hfg-karlsruhe.de/apps/contacts/circle/5brS9N1EiZj2wMFQawiStcUORcMjVUb).

Both platforms are used as a preparation for publishing materials or for sharing and discussing, and follows the same principles of other projects or courses in the university (which define the framework how far the materials in the platforms can be stored for documentation or archival purposes). We did not find any specific privacy policy for the instance of these platforms, so we assume, we are under the [general privacy policy of the HfG Karlsruhe](https://hfg-karlsruhe.de/datenschutz/).
...
[Article 12.1 of GDPR](https://gdpr-info.eu/art-12-gdpr/) requires us to have this information concise, transparent, intelligible and easily accessible. We tried our best to have it concise, intelligible and easy accessible, but we stroke to make it transparent, which in our humble experience would make it less easy to read. [Recital 58, called "The principle of Transparency"](https://gdpr-info.eu/recitals/no-58/) repeats the ideas on Article 12 without providing a clear definition of what is meant by transparency:
