...
To create subfolders with files, you can simply create new markdon files. For example:
 ...
 - `_docs/subfolder/example-page.md` renders to `http://localhost:4000/docs/subfolder/example-page/`
 - `_docs/subfolder.md` renders to `http://localhost:4000/docs/subfolder/`
